...
(function (root, factory) {
    ...
    function _bind(options, cb) {
        ...
        return loadImage(url, hasExif).then(function (img) {
            ...
            if (!points.length) {
                ...
                var rect = (self.options.captureFromBoundary ? self.elements.boundary.getBoundingClientRect() : self.elements.viewport.getBoundingClientRect());
    ...
    function _get() {
        var self = this,
            imgData = self.elements.preview.getBoundingClientRect(),
            // vpData = self.elements.viewport.getBoundingClientRect(),
            rect = (self.options.captureFromBoundary ? self.elements.boundary : self.elements.viewport),
            vpData = rect.getBoundingClientRect(),
            x1 = vpData.left - imgData.left,
            y1 = vpData.top - imgData.top,
            widthDiff = (vpData.width - rect.offsetWidth) / 2, //border
            heightDiff = (vpData.height - rect.offsetHeight) / 2,
            x2 = x1 + rect.offsetWidth + widthDiff,
            y2 = y1 + rect.offsetHeight + heightDiff,
            scale = self._currentZoom;
    ...
    function _result(options) {
        var self = this,
            ...
            vpRect = rect.getBoundingClientRect(),
